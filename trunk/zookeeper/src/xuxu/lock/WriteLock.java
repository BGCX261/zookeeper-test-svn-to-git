...
public class WriteLock extends ProtocolSupport {
     ...
     */
    public WriteLock(ZooKeeper zookeeper, String dir, List<ACL> acl) throws KeeperException, InterruptedException {
        super(zookeeper);
     ...
     * @throws KeeperException
     */
    public WriteLock(ZooKeeper zookeeper, String dir, List<ACL> acl, LockListener callback) throws KeeperException,
    ...
    private class LockZooKeeperOperation implements ZooKeeperOperation {
         ...
         * @throws InterruptedException
         */
        private void findPrefixInChildren(String prefix, ZooKeeper zookeeper, String dir) throws KeeperException,
                InterruptedException {
